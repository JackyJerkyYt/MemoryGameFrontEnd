...
import AdminPageUsers from '../AdminPageUser';
    ...
    <div className="App">
      ...
      <h1 onClick = {testingHandleClick}>Are You a Gold Fish?</h1>
      {
        ...
        userReadTheInstructions ? 
          ...
          :
          <div> 
            <div>Instructions: Tap all the tiles that had turned blue to pass to the next round!</div>
            <br></br>
            <br></br>
            <div>
            ...
            <br></br>
            <Profiles Leaderboard={usersArray} isAdmin={true}/>
          </div>
